...
MotorController Motor_R(&htim5, &htim2, TIM_CHANNEL_1, GPIOB, GPIO_PIN_12, 1.1, 40, 0);
MotorController Motor_L(&htim3, &htim2, TIM_CHANNEL_3, GPIOB, GPIO_PIN_4 , 1.1, 40, 0);
