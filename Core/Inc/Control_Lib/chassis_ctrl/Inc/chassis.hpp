...
class Chassis {
    public:
        ...
        void Differencial_ForwardKinematics();                             // Compute the forward kinematics of differential chassis
        void Differencial_InverseKinematics();                             // Compute the inverse kinematics of differential chassis
